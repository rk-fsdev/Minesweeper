...
export const generateCells = (cols: number, rows: number, mines: number): Cell[][] => {
...
export const makeMines = (mineCount: number, cells: Cell[][], options: number[][]): Cell[][] => {
...
export const revealCell = (cols: number, rows: number, col: number, row: number, cells: Cell[][]): void => {
...
export const flagCell = (col: number, row: number, cells: Cell[][]): void => {
